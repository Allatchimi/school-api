...
func RegisterEndpoints(
	...
	const tableName = constants.RESOURCE_TABLE_HIGHSCHOOL_SECTION
	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Create new section and return created object.",
	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Delete multiple section by providing a list of IDs and return affected rows in database.",
			Method:      http.MethodDelete,

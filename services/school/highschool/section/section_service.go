...
func (service *Service) Create(inputJwtToken *types.JwtToken, request *data.SectionRequest) (result *model.HighschoolSection, errCode int, err error) {
	// Format request
...
func (service *Service) Update(inputJwtToken *types.JwtToken, id int64, request *data.SectionRequest) (result *model.HighschoolSection, errCode int, err error) {
	// Format request
	item := &model.HighschoolSection{
		SchoolID:    request.SchoolID,
		Name:        request.Name,
...
func (service *Service) GetAll(inputJwtToken *types.JwtToken, filter *types.Filter, pagination *types.Pagination, request *data.GetAllRequest) (result []model.HighschoolSection, errCode int, err error) {

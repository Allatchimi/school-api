...
func (repository *Repository) Create(item *model.HighschoolSpecialty) (result *model.HighschoolSpecialty, err error) {
	// Create the item
...
func (repository *Repository) UpdateByID(id int64, item *model.HighschoolSpecialty) (result *model.HighschoolSpecialty, err error) {
	// Update the item

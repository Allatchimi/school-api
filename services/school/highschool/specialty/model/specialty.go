...
type HighschoolSpecialty struct {
	...
	Section   *modelSection.HighschoolSection `gorm:"default:null;foreignKey:SectionID;references:ID;constraint:onDelete:CASCADE,onUpdate:CASCADE;"`

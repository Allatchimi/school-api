	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Create new specialty and return created object.",
	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Delete multiple specialty by providing a list of IDs and return affected rows in database.",
			Method:      http.MethodDelete,

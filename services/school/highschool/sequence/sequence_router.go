...
func RegisterEndpoints(
	...
	const tableName = constants.RESOURCE_TABLE_HIGHSCHOOL_SEQUENCE
	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Delete multiple sequence by providing a list of IDs and return affected rows in database.",
			Method:      http.MethodDelete,

	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Create new semester and return created object.",
	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Delete multiple semester by providing a list of IDs and return affected rows in database.",
			Method:      http.MethodDelete,

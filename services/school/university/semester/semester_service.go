...
const MODEL_NAME = "semester"
const DEFAULT_ERROR_MESSAGE = "interact with semester model"

func (service *Service) Create(inputJwtToken *types.JwtToken, request *data.SemesterRequest) (result *model.UniversitySemester, errCode int, err error) {
	// Format request
	item := &model.UniversitySemester{
...
func (service *Service) Update(inputJwtToken *types.JwtToken, id int64, request *data.SemesterRequest) (result *model.UniversitySemester, errCode int, err error) {
	// Format request
	item := &model.UniversitySemester{
		SchoolID:    request.SchoolID,
		Name:        request.Name,
...
func (service *Service) Get(inputJwtToken *types.JwtToken, id int64) (result *model.UniversitySemester, errCode int, err error) {
...
func (service *Service) GetAll(inputJwtToken *types.JwtToken, filter *types.Filter, pagination *types.Pagination, request *data.GetAllRequest) (result []model.UniversitySemester, errCode int, err error) {

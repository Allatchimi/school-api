	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Create new domain and return created object.",
	...
	huma.Register(
		*humaApi,
		huma.Operation{
			...
			Description: "Delete multiple domain by providing a list of IDs and return affected rows in database.",
			Method:      http.MethodDelete,

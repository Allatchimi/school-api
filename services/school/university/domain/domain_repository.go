...
func (repository *Repository) Create(item *model.UniversityDomain) (result *model.UniversityDomain, err error) {
	// Create the item
...
func (repository *Repository) UpdateByID(id int64, item *model.UniversityDomain) (result *model.UniversityDomain, err error) {
	// Update the item

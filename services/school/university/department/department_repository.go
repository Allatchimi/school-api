...
func (repository *Repository) Create(item *model.UniversityDepartment) (result *model.UniversityDepartment, err error) {
	// Create the item
...
func (repository *Repository) UpdateByID(id int64, item *model.UniversityDepartment) (result *model.UniversityDepartment, err error) {
	// Update the item
	...
	err = repository.Db.
		Model(&model.UniversityDepartment{}).
		Where("id = ?", id).

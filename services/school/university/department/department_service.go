...
const DEFAULT_ERROR_MESSAGE = "interact with department model"

func (service *Service) Create(inputJwtToken *types.JwtToken, request *data.DepartmentRequest) (result *model.UniversityDepartment, errCode int, err error) {
	// Format request
	item := &model.UniversityDepartment{
...
func (service *Service) Update(inputJwtToken *types.JwtToken, id int64, request *data.DepartmentRequest) (result *model.UniversityDepartment, errCode int, err error) {
	// Format request
	item := &model.UniversityDepartment{
		SchoolID:    request.SchoolID,
		FacultyID:   request.FacultyID,
...
func (service *Service) GetAll(inputJwtToken *types.JwtToken, filter *types.Filter, pagination *types.Pagination, request *data.GetAllRequest) (result []model.UniversityDepartment, errCode int, err error) {

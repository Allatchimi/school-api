...
const MODEL_NAME = "faculty"
const DEFAULT_ERROR_MESSAGE = "interact with faculty model"

func (service *Service) Create(inputJwtToken *types.JwtToken, request *data.FacultyRequest) (result *model.UniversityFaculty, errCode int, err error) {
	// Format request
	item := &model.UniversityFaculty{
...
func (service *Service) Update(inputJwtToken *types.JwtToken, id int64, request *data.FacultyRequest) (result *model.UniversityFaculty, errCode int, err error) {
	// Format request
	item := &model.UniversityFaculty{
		SchoolID:    request.SchoolID,
		Name:        request.Name,
...
func (service *Service) GetAll(inputJwtToken *types.JwtToken, filter *types.Filter, pagination *types.Pagination, request *data.GetAllRequest) (result []model.UniversityFaculty, errCode int, err error) {

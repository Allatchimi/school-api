...
func (repository *Repository) Create(item *model.UniversityFaculty) (result *model.UniversityFaculty, err error) {
	// Create the item
...
func (repository *Repository) UpdateByID(id int64, item *model.UniversityFaculty) (result *model.UniversityFaculty, err error) {
	// Update the item

...
type UniversityUnit struct {
	...
	Semester   *modelSemester.UniversitySemester `gorm:"default:null;foreignKey:SemesterID;references:ID;constraint:onDelete:CASCADE,onUpdate:CASCADE;"`

...
func (controller *Controller) Get(
	...
	payment, errCode, err := controller.Service.Get(httpHelper.GetJwtContext(ctx), input.ID)
	if err != nil {
		return
	}
	result = payment
...
func (controller *Controller) GetAll(
	...
	paymentList, errCode, err := controller.Service.GetAll(httpHelper.GetJwtContext(ctx), newFilter, newPagination, input.SchoolID)
	if err != nil {
		return
	}
